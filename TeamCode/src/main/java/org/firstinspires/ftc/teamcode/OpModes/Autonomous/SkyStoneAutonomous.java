...
@Autonomous(name="SkyStoneAutonomous", group= "Linear Opmode")
public class SkyStoneAutonomous extends Waypoint_Nav_Base {
    Robot robot;
        ...
        try {
            ...
            while ( !gamepad2.x && !isStopRequested()) {
                ...
                if (CheckForButtonEvent(prev_gamepad2.dpad_left,gamepad2.dpad_left)) {
                    autoStartingLocation = AutonomousStartLocation.BLUE_RIGHT;
                }
                prev_gamepad2.copy(gamepad2);
                telemetry.update();
            ...
            if (autoStartingLocation == AutonomousStartLocation.RED_LEFT) {
            ...
            if (autoStartingLocation == AutonomousStartLocation.RED_RIGHT ||
                    autoStartingLocation == AutonomousStartLocation.RED_LEFT) {
...
//                    AddDeliverSkystoneWaypoint();
    ...
    private void AddFoundationWaypoint(final boolean stone_delivery) {
        ...
        int x_coord = (stone_delivery) ? 1300 : 1200;
...
//                    robot.sliderArm.toggleSliderLevels(true);
                ...
                if (stone_delivery == true) {
                    robot.placingSystem.openDingusKahn(); // let go og stone
                }
...
//                }
    ...
    private void AddOuterBridgeWaypoint(Coordinate.Direction dir) {
        waypoints.add(new Waypoint(new Coordinate(150, /*100*/1700 * alliance_mirror_adjustor, dir)));
